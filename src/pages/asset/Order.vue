<template>
  <div class="bh-root">
    ...
    <el-row>
      <el-col :span="24">
        <span class="bh-font_size__big" :class="{'bh-color_standard': selected==='ongoing'}" @click="select('ongoing')">进行中订单</span>
        <span class="bh-font_size__big" :class="{'bh-color_standard': selected==='completed'}" @click="select('completed')">已完成订单</span>
        <span class="bh-font_size__big" :class="{'bh-color_standard': selected==='cancel'}" @click="select('cancel')">取消订单</span>
