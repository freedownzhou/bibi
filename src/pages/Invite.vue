        ...
        <div class="bgColor-f myShareBox">
          ...
          <div class="rightBox">
            <el-carousel type="card" height="334px;" :interval="0" indicator-position="none" arrow="always" class="invite-swiper" @change="changeCarousel">
              <el-carousel-item>
                <img id="img0" src="http://8bihui-webapp.oss-cn-beijing.aliyuncs.com/images/invite/bg1.jpg" crossorigin="anonymous">
                <vue-qr id="qr" :logoSrc="codeLogo" :text="copySrc1" :size="200" :margin="0" :whiteMargin="true" class="invite-qr"></vue-qr>
              </el-carousel-item>
              <el-carousel-item>
                <img id="img1" src="http://8bihui-webapp.oss-cn-beijing.aliyuncs.com/images/invite/bg2.jpg" crossorigin="anonymous">
                <vue-qr :logoSrc="codeLogo" :text="copySrc1" :size="200" :margin="0" :whiteMargin="true" class="invite-qr"></vue-qr>
              </el-carousel-item>
              <el-carousel-item>
                <img id="img2" src="http://8bihui-webapp.oss-cn-beijing.aliyuncs.com/images/invite/bg3.png" crossorigin="anonymous">
                <vue-qr :logoSrc="codeLogo" :text="copySrc1" :size="200" :margin="0" :whiteMargin="true" class="invite-qr"></vue-qr>
              </el-carousel-item>
              <el-carousel-item>
                <img id="img3" src="http://8bihui-webapp.oss-cn-beijing.aliyuncs.com/images/invite/bg4.png" crossorigin="anonymous">
                <vue-qr :logoSrc="codeLogo" :text="copySrc1" :size="200" :margin="0" :whiteMargin="true" class="invite-qr"></vue-qr>
              </el-carousel-item>
              <!--<el-carousel-item>-->
                <!--<img id="img4" src="../assets/images/invite/bg5.jpg">-->
                <!--<vue-qr :logoSrc="codeLogo" :text="copySrc1" :size="200" :margin="0" :whiteMargin="true" class="invite-qr"></vue-qr>-->
              <!--</el-carousel-item>-->
              <!--<el-carousel-item>-->
                <!--<img id="img5" src="../assets/images/invite/bg6.jpg">-->
                <!--<vue-qr :logoSrc="codeLogo" :text="copySrc1" :size="200" :margin="0" :whiteMargin="true" class="invite-qr"></vue-qr>-->
              <!--</el-carousel-item>-->
            </el-carousel>
