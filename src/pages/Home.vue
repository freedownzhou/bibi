          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide swiper-no-swiping">
              <a target="_blank" href="/activity">
                <img src="https://8bihui-webapp.oss-cn-beijing.aliyuncs.com/images/home/banner2.jpg">
              </a>
            </div>
            <div class="swiper-slide swiper-no-swiping">
              <img src="https://8bihui-webapp.oss-cn-beijing.aliyuncs.com/images/home/banner.jpg">
              <a class="openBtn" href="/otc_trading"></a>
            </div>
            <div class="swiper-slide swiper-no-swiping">
              <img src="https://8bihui-webapp.oss-cn-beijing.aliyuncs.com/images/home/banner1.jpg"/>
              <!--<a class="banner1Btn" target="_blank" href="https://8bihui.zendesk.com/hc/zh-cn/community/posts/360034987571-ADC%E4%B8%8A%E7%BA%BF%E5%B8%81%E6%B1%87%E4%BA%A4%E6%98%93%E6%89%80%E6%B4%BB%E5%8A%A8"></a>-->
            </div>
          </div>
    ...
    <main class="content">
      ...
      <div class="conBox bh-notify">
        <div class="bh-notify_content">
          ...
          <span class="bh-notify-content cur" v-show="active_Title.title" @click="$router.push({ name: 'FrequentlyAskedQuestion', params: {type: 1, myId: categoryId, helpId: active_Title.id} })">{{active_Title.title}}</span>
