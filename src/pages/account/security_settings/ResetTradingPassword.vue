<template>
  <div class="bh-update_phone_lost">
    ...
    <el-row>
      <el-col :span="24">
        <span class="bh-background_normal bh-font_subtitle">资金密码重置</span>
      </el-col>
    </el-row>
    ...
    <el-row>
      ...
      <el-col :span="7">
        <el-input type="password" maxlength="6" v-model="newPassword" placeholder="请输入新密码" @focus="checkNewPasswordByFocus" @blur="checkNewPasswordByBlur"></el-input>
    ...
    <el-row>
      ...
      <el-col :span="7">
        <el-input type="password" maxlength="6" v-model="confirmPassword" placeholder="确认密码" @focus="checkConfirmPasswordByFocus" @blur="checkConfirmPasswordByBlur"></el-input>
        <transition name="el-fade-in-linear">
    ...
    <el-row>
      <el-col type="flex" :span="4" >
        <span class="bh-col_1 bh-font_normal">短信验证码</span>
      </el-col>
      <el-col :span="7">
        <el-input v-model="captcha" maxlength="6" placeholder="请输入验证码" @focus="checkCaptchaByFocus" @blur="checkCaptchaByBlur"></el-input>
        <transition name="el-fade-in-linear">
...
export default {
  ...
  methods: {
    ...
    commit () {
      this.$store.dispatch('encryptConnection', {
        url: '/userinfo/resetAssetPasswordUI',
        data: {
