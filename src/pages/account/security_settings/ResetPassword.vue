<template>
  <div class="bh-update_phone_lost">
    ...
    <el-row>
      <el-col :span="24">
        <span class="bh-background_normal bh-font_subtitle">登录密码重置</span>
      </el-col>
    </el-row>
    ...
    <el-row>
      <el-col :span="24">
        ...
        <span class="bh-font_size__small bh-color_prompt">为了您的资产安全，修改资金密码24小时内不允许提币。</span>
      </el-col>
    </el-row>
...
export default {
  ...
  computed: {
    disabled () {
      return this.newPasswordTestResults === true &&
        this.confirmPasswordTestResults === true &&
        this.captchaTestResults === true
    }
  },
  methods: {
    ...
    commit () {
      this.$store.dispatch('encryptConnectionSSO', {
        url: '/sso/user/resetPassword',
        data: {
          userId: this.user.userId + '',
          source: '2',
          telephone: this.user.telephone ? this.user.telephone : '',
          email: this.user.telephone ? null : this.user.email,
