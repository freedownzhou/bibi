<template>
  <div class="bh-update_phone_lost">
    ...
    <el-row>
      <el-col :span="24">
        <span class="bh-background_normal bh-font_subtitle">{{$t('title.VerificationMobilePhone')}}</span>
      </el-col>
    </el-row>
    ...
    <el-row>
      <el-col :span="4" type="flex">
        <span class="bh-col_1 bh-font_normal">地区</span>
      </el-col>
      <el-col :span="7">
    ...
    <el-row>
      <el-col :span="4" type="flex">
        <span class="bh-col_1 bh-font_normal">手机号码</span>
      </el-col>
      <el-col :span="7">
    ...
    <el-row>
      <el-col type="flex" :span="4" >
        <span class="bh-col_1 bh-font_normal">邮箱验证码</span>
      </el-col>
      <el-col :span="7">
...
export default {
  ...
  methods: {
    ...
    commit () {
      ...
      // 认证用户手机
      this.$store.dispatch('encryptConnectionSSO', {
        url: '/sso/user/phoneAuthenticationUI',
        data: {
          userId: this.$store.getters.getUser.userId + '',
          telephone: this.newTelephone,
          telephoneCode: this.newTelephoneCode,
          countryCode: this.iTelCode,
