<template>
  <div class="bh-root">
    ...
    <el-row>
      <el-col :span="24">
        <span class="bh-background_normal bh-font_subtitle">{{$t('menu.SecuritySettings')}}</span>
      </el-col>
    </el-row>
    ...
    <el-row>
      <el-col :span="24">
        ...
        <span class="bh-font_size__small bh-color_prompt">安全提示：请不要透露短信和谷歌验证码给任何人。</span>
      </el-col>
    </el-row>
    ...
    <el-row>
      <el-col :span="3">
        <span class="bh-font_normal">手机认证</span>
      </el-col>
      ...
      <el-col :span="10">
        <span class="bh-font_size__small bh-color_standard">登录、提现、修改密码，及安全设置时用以收取验证短信。</span>
      </el-col>
    ...
    <el-row>
      <el-col :span="3">
        <span class="bh-font_normal">邮箱认证</span>
      </el-col>
      ...
      <el-col :span="10">
        <span class="bh-font_size__small bh-color_standard">邮箱用于登录、提现及安全设置时使用，激活后不可修改。</span>
      </el-col>
    ...
    <el-row>
      <el-col :span="3">
        <span class="bh-font_normal" style="">Google认证</span>
      </el-col>
      ...
      <el-col :span="10">
        <span class="bh-font_size__small bh-color_standard">提现，修改密码，及安全设置时用以输入谷歌验证码详细信息请阅读，使用指南;下载:Andriod/iOS。</span>
      </el-col>
    ...
    <el-row>
      <el-col :span="3">
        <span class="bh-font_normal">实名认证</span>
      </el-col>
      ...
      <el-col :span="10">
        <span class="bh-font_size__small bh-color_standard">为了您的资金安全，需验证您的身份才可进行交易；认证信息一经验证不能修改，请务必如实填写。</span>
      </el-col>
    ...
    <el-row>
      <el-col :span="3">
        <span class="bh-font_normal">资金密码</span>
      </el-col>
      ...
      <el-col :span="10">
        <span class="bh-font_size__small bh-color_standard">交易，提现时使用。</span>
      </el-col>
    ...
    <el-row>
      <el-col :span="3">
        <span class="bh-font_normal">登录密码</span>
      </el-col>
      ...
      <el-col :span="10">
        <span class="bh-font_size__small bh-color_standard">安全级别</span>
