<template>
  <div class="bh-update_phone">
    ...
    <el-row>
      <el-col :span="24">
        <span class="bh-background_normal bh-font_subtitle">{{$t('title.UpdateVerifiedMobilePhone')}}</span>
      </el-col>
    </el-row>
    ...
    <el-row>
      <el-col :span="4" type="flex">
        <span class="bh-col_1 bh-font_normal">原手机号码</span>
      </el-col>
      <el-col :span="7">
    ...
    <el-row>
      <el-col :span="4" type="flex">
        <span class="bh-col_1 bh-font_normal">新手机号码</span>
      </el-col>
      <el-col :span="7">
    ...
    <el-row>
      <el-col type="flex" :span="4" >
        <span class="bh-col_1 bh-font_normal">原手机短信验证码</span>
      </el-col>
      <el-col :span="7">
    ...
    <el-row>
      <el-col type="flex" :span="4" >
        <span class="bh-col_1 bh-font_normal">新手机短信验证码</span>
      </el-col>
      <el-col :span="7">
