<template>
  <div class="bh-root">
    <div>
      ...
      <el-row>
        <el-col :span="24">
          <span class="bh-background_normal bh-font_subtitle">{{$t('title.VerificationPersonalIdentity')}}</span>
        </el-col>
      </el-row>
    ...
    <!--帮助呢-->
    <el-row class="bh-background_normal">
      <el-col :span="24" class="bh-font_list">
...
export default {
  ...
  computed: {
    ...
    identityAuthenticator () {
      return Number(this.$store.getters.getUser.identityAuthenticator)
    }
  },
  watch: {
    // 实名认证
  ...
  methods: {
    refresh () {
      const level = this.identityAuthenticator
      switch (level) {
        case 0:
        ...
        case 1:
          ...
          break
        case 2:
          this.$router.push({name: 'AuthenticationMediumAudit', query: {cause: 0}})
          break
        case 2.1:
          this.$router.push({name: 'AuthenticationMediumAudit', query: {cause: 1}})
          break
        case 2.2:
          this.$router.push({name: 'AuthenticationMediumAudit', query: {cause: 2}})
          break
        case 2.3:
          this.$router.push({name: 'AuthenticationMediumAudit', query: {cause: 3}})
          break
        case 3:
