  ...
  <div class="bh-root">
    ...
    <el-row>
      <el-col class="bh-upload" :span="8">
        <span class="bh-font_list">证件正面照</span>
        <div>
          <el-upload v-loading="committing" class="upload-demo" action=""
      ...
      <el-col class="bh-upload" :span="8">
        <span class="bh-font_list">证件反面照</span>
        <div>
          <el-upload v-loading="committing" class="upload-demo" action=""
                     :show-file-list="false" accept="image/*"
      ...
      <el-col class="bh-upload" :span="8">
        <span class="bh-font_list">手持证件照</span>
        <div>
          <el-upload v-loading="committing" class="upload-demo" action=""
                     :show-file-list="false" accept="image/*"
    ...
    <el-row>
      <el-col :span="24">
        <button class="center-float-center bh-btn_primary" @click="commit" :disabled="!(front&&back&&grasp&&!committing)">确认</button>
      </el-col>
    </el-row>
...
export default {
  ...
  methods: {
    frontHandleChange (file) {
      // 清除上一张图片的缓存
      this.$convertImg.clear()
      this.$convertImg.convertToBase64(file.url, 750, 468, (base64) => {
        this.front = base64
      })
    },
...
<style scoped>
  ...
  .bh-btn_primary {
    width: 200px;
    height: 36px;position: relative;margin: 0 auto;
  }
</style>
