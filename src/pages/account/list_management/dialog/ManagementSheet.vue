        ...
        <div class="bh-order">
          <div class="bh-order_menu">
            <el-row style="margin: 30px 0 14px 0;">
              <el-col :span="24">
                <span class="bh-font_size__big" :class="{'bh-color_select': selected==='ongoing'}" @click="select('ongoing')" style="font-size: 14px;display: inline-block; margin-right: 20px;cursor:pointer;">出售广告</span>
                <span class="bh-font_size__big" :class="{'bh-color_select': selected==='completed'}" @click="select('completed')" style="font-size: 14px;display: inline-block; margin-right: 20px;cursor:pointer;">购买广告</span>
                <span class="bh-font_size__big" :class="{'bh-color_select': selected==='cancel'}" @click="select('cancel')" style="font-size: 14px;cursor:pointer;">最近交易记录</span>
