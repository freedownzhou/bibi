<template>
  <div class="bh-root">
    <div style="margin-bottom: 80px;">
      ...
      <el-row>
        <el-col :span="24">
          <span class="bh-background_normal bh-font_subtitle">信任名单</span>
        </el-col>
      </el-row>
      ...
      <el-row>
        <el-col :span="24">
          ...
          <span class="bh-font_size__small bh-color_prompt">设置信任名单后，对方发布的交易信息将会推送给您。</span>
        </el-col>
      </el-row>
    ...
    <div>
      ...
      <el-row>
        <el-col :span="24">
          <span class="bh-background_normal bh-font_subtitle">黑名单</span>
        </el-col>
      </el-row>
      ...
      <el-row>
        <el-col :span="24">
          <i class="iconfont icon-tanhao"></i>
          <span class="bh-font_size__small bh-color_prompt">拉黑对方后您将无法再和对方产生交易订单，您可以在黑名单管理里面解除该限制。</span>
        </el-col>
      </el-row>
      <!--黑名单-->
      <el-row  style="margin: 2px 2px 50px 2px;">
