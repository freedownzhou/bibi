    ...
    <main id="particles-js">
      <div class="bh-login">
        <div class="bh-login_header">
          ...
          <span class="bh-font_size__standard bh-color_white">安全、可靠、交易快速</span>
        </div>

        <!--注册方式切换-->
        <div class="bh-login_body">
          <div>
            <button class="bh-btn_text bh-color_light" :class="{'bh-active': accountType}" @click="toggleAccountType(true)">手机注册</button>
            <button class="bh-btn_text bh-color_light" :class="{'bh-active': !accountType}" @click="toggleAccountType(false)">邮箱注册</button>
          </div>
          ...
          <div class="bh-protocol">
            ...
            <span class="bh-font_normal">我已阅读并同意《<button class="bh-btn_text bh-color_select" @click="showProtocolDialog=true">网络服务协议</button>》</span>
          </div>
